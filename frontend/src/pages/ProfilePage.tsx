              ...
              {isOwner && (
                <>
                  <button
                    ...
                    className="w-8 h-8 rounded-full flex items-center justify-center text-[#71767b] hover:text-[#1d9bf0] hover:bg-[#1d9bf0]/10 transition-colors"
                    title="Edit"
                  >
                  ...
                  <button
                    ...
                    className="w-8 h-8 rounded-full flex items-center justify-center text-[#71767b] hover:text-red-400 hover:bg-red-400/10 transition-colors"
                    title="Delete"
                  >
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
