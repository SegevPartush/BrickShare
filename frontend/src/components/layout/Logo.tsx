  ...
  return (
    <div className="flex items-center gap-3">
      <div
        ...
        style={{ width: size, height: size, background: 'linear-gradient(135deg, #1d9bf0 0%, #38bdf8 100%)' }}
      >
      ...
      <div>
        ...
        <div className="text-[#71767b] leading-tight mt-[-2px]" style={{ fontSize: size * 0.21 }}>
